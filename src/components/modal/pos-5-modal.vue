            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="KiloG" id="kilog" placeholder="Kilogram" />
                </div>
              </div>
            </div>
          </div>
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="PosTax" id="postax" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="NewPos" id="newpos" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="FlatSel" id="flatsel" placeholder="Select" />
            </div>
            <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="CreditSel" id="creditsel" placeholder="Cash" />
                </div>
...
export default {
  data() {
    return {
      ...
      PosPercentage: ["Percentage", "Early Payment Discounts"],
      KiloG: ["Kilogram", "Grams"],
      NewPos: ["Select", "NEWYEAK30", "CHRISTMAS100", "HALLOWEEN20", "BLACKFRIDAY50"],
      FlatSel: ["Select", "Flat", "Percentage"],
      PosTax: ["Select", "No Tax", "@10", "@15", "VAT", "SLTAX"],
      CreditSel: ["Credit Card", "Cash", "Cheque", "Deposit", "Points"],
      CreditSelOne: ["Credit Card", "Cash", "Cheque", "Deposit", "Points"],
      CreditSelTwo: ["Credit Card", "Cash", "Cheque", "Deposit", "Points"],
      CreditSelThree: ["Credit Card", "Cash", "Cheque", "Deposit", "Points"],
      CreditSelFour: ["Credit Card", "Cash", "Cheque", "Deposit", "Points"],
    };
  },
  methods: {
    submitForm() {

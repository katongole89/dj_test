            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="Taxtype" id="pos-type" placeholder="Exclusive" />
                </div>
              </div>
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="Sale" id="pos-sale" placeholder="Kilogram" />
                </div>
              </div>
            </div>
          </div>
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="Order" id="pos-order" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="Coupon" id="pos-coupon" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="OrderType" id="pos-ordertype" placeholder="Select" />
            </div>
            <div class="mb-3">
            ...
            <div class="additem-info">
              <div class="bg-light p-3 add-info">
                <div class="row align-items-center g-2">
                  ...
                  <div class="col-lg-4">
                    <vue-select :options="Payment" id="pos-payment" placeholder="Cash" />
                  </div>
                  <div class="col-lg-4">
              ...
              <div class="bg-light p-3 add-info">
                <div class="row align-items-center g-2">
                  ...
                  <div class="col-lg-4">
                    <vue-select :options="Payment" id="pos-payment2" placeholder="Cash" />
                  </div>
                  <div class="col-lg-4">
                    <input type="text" class="form-control" placeholder="Enter Amount" />
                  </div>
...
export default {
  ...
  data() {
    return {
      ...
      Sale: ["Kilogram", "Grams"],
      Order: ["Select", "No Tax", "@10", "@15", "VAT", "SLTAX"],
      Coupon: ["Select", "NEWYEAR30", "CHRISTMAS100", "HALLOWEEN20", "BLACKFRIDAY50"],
      OrderType: ["Select", "Flat", "Percentage"],
      Payment: ["Cash", "Card"],
      tags: ["Credit Card", "Cash", "Cheque", "Deposit", "Points"],
    };
  },
  methods: {
    submitForm() {

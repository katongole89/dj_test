              ...
              <form @submit.prevent="submitForm">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 mb-3">
                    ...
                    >
                    <vue-select :options="City" id="city-billers" placeholder="Select" />
                  </div>
                  <div class="col-lg-6 mb-3">
                    <label class="form-label"
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 mb-3">
                    <label class="form-label"
                      >City<span class="text-danger ms-1">*</span></label
                    >
                    <vue-select :options="City" id="city-billers1" placeholder="USA" />
                  </div>
                  <div class="col-lg-6 mb-3">
                    <label class="form-label"
                      >State<span class="text-danger ms-1">*</span></label
...
export default {
  data() {
    return {
      City: ["Select", "United Kingdom", "United State"],
      State: ["Select", "United Kingdom", "United State"],
      Country: ["Select", "United Kingdom", "United State"],
    };
  },
  methods: {
    submitForm() {

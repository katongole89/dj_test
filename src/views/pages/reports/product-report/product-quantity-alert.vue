...
export default {
  data() {
    return {
      IdeapadQu: ["All", "Lenovo", "Beats Pro", "Nike Jordan"],
      BrandQuant: ["All", "Lenovo", "Beats", "Nike"],
      CateQuant: ["All", "Computers", "Electronics", "Shoe"],
      QuantPro: ["All", "Electro Mart", "Quantum Gadgets", "Prime Bazaar"],
    };
  },
  setup() {

                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="mb-3">
                        ...
                        <vue-select :options="CarLamon" id="carlamon" placeholder="All" />
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="mb-3">
                        <label class="form-label">Products</label>
                        <vue-select :options="BeaTBest" id="beatbest" placeholder="All" />
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  data() {
    return {
      CarLamon: ["All", "Carl Evans", "Minerva Rameriz", "Robert Lamon"],
      BeaTBest: ["All", "Lenovo IdeaPad 3", "Beats Pro"],
    };
  },
  setup() {
